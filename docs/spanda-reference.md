...
> Generated by `spanda reference` / `scripts/generate_spanda_reference.py`. Signatures come from the type checker (`spanda-typecheck`, re-exported by `spanda-driver` / `spanda-core`).

See also: [api-documentation.md](./api-documentation.md) (how API docs relate) · [spanda-language.md](./spanda-language.md) (tutorial-style guide) · [standard-library.md](./standard-library.md) (stdlib overview) · [spanda-type-system.md](./spanda-type-system.md) (type rules).
