...
- **Deploy certification gate:** deploy plans embed certification proof summaries; `spanda deploy rollout --require-certify` blocks OTA when strict proof fails; TypeScript deploy-service and `verify-adapter` Node fallback mirror Rust behavior
