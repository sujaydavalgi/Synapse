...
- **Phase 25 (in progress):** P0 v0.5 beta golden paths — `killer_demo_golden_path.sh`, `live_ai_golden_path.sh`, `ros2_golden_path.sh`, `registry_golden_path.sh`; CI jobs; [ros2_cmd_vel_ping.sd](examples/communication/ros2_cmd_vel_ping.sd); VS Code `vsce publish` on release when `VSCE_PAT` is set.
