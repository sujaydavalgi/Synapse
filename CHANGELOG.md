...
- **Enterprise ops Stable promotion gate:** `enterprise_ops_stable_promotion_gate.sh` + `enterprise_ops_field_soak_init.sh`; runbook [enterprise-ops-stable-promotion.md](docs/enterprise-ops-stable-promotion.md); CI job `enterprise-ops-promotion-gate`.
