...
- **Persistent telemetry store:** Prometheus text export (`spanda telemetry prometheus`); session/run linking; end-of-run `runtime_metrics` snapshots; JSONL retention via `SPANDA_TELEMETRY_MAX_EVENTS`; TS CLI JSONL fallback
