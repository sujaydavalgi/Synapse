...
pub use store::{
    ...
    record_sensor_reading, record_task_heartbeat, resolve_heartbeat_index_path, resolve_store_path,
    wall_timestamp_ms, PersistentTelemetryStore, TelemetryQuery, TelemetryStats,
};
