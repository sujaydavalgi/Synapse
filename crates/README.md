...
| **Hardware & verify** | [`spanda-hardware`](spanda-hardware/README.md), [`spanda-certify`](spanda-certify/README.md), `spanda-capability` | `spanda verify`, certification proofs, capability/traceability/health analysis |
